...
//         <span className="bg-gradient-to-r from-amber-400 to-orange-400 text-white px-4 py-2 rounded-full text-sm font-extrabold tracking-wide shadow-sm absolute top-0 left-2">
//           Featured
//         </span>
//       </div>
...
//                   <h2 className="text-2xl sm:text-3xl lg:text-4xl font-medium paragraph-font tracking-wide text-gray-900 leading-tight">
//                     {post.title}
//                   </h2>

//                   <p className="text-gray-600 paragraph-font tracking-wide text-base lg:text-lg leading-relaxed max-w-lg">
//                     {post.description}
//                   </p>
